            ...
            <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
                ...
                <div className="flex flex-col items-center md:items-end">
                    ...
                    <div className="flex justify-center md:justify-start gap-4 text-xl dark:text-gray-100 text-gray-800">
                        ...
                        <a href="https://linkedin.com/in/melbin-mathew-7996b82b5" className="hover:text-violet-600" target="_blank" rel="noreferrer">
                            <FaLinkedin />
                        </a>
                        ...
                        <a href="https://www.instagram.com/triumph_beau?igsh=MXc1Y25mOWN0emw5aw==" className="hover:text-violet-600" target="_blank" rel="noreferrer">
                            <FaInstagram />
                        </a>
                    </div>
                </div>
